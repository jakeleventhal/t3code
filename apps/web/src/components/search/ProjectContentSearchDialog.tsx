...
function ContentSearchPopup(props: { readonly children: ReactNode }) {
  return (
    <DialogPopup
      className="h-[min(44rem,82vh)] max-w-3xl overflow-hidden"
      data-command-palette="true"
      data-testid="project-content-search"
...
function EmptyContentSearchDialog() {
  return (
    <ContentSearchPopup>
      <DialogTitle className="sr-only">Search project contents</DialogTitle>
...
function OpenContentSearchDialog(props: {
  ...
  return (
    <ContentSearchPopup>
      <DialogTitle className="sr-only">Search {target.projectName}</DialogTitle>
