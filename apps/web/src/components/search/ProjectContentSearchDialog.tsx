...
function EmptyContentSearchDialog() {
  return (
    <div className="flex h-105 min-h-0 flex-col" data-testid="project-content-search">
      <Command aria-label="Search project contents" mode="none" value="">
        <CommandInput disabled placeholder="Search project contents…" />
        <CommandPanel className="flex min-h-0 flex-1 items-center justify-center px-6 text-center text-sm text-muted-foreground">
