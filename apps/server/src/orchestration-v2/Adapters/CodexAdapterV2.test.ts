...
describe("CodexAdapterV2 post-settle continuation", () => {
  ...
  it.effect("resubmits a voice handoff Codex started only after its turn is interrupted", () =>
    Effect.scoped(
      Effect.gen(function* () {
        ...
        const harness = yield* makeCodexReplayHarness(
          makeCodexReplayTranscript({
            ...
            entries: [
              ...
              ...codexReplayPreamble({ nativeThreadId, nativeTurnId: "unused", prompt: "" }).slice(
                0,
                -3,
              ),
              {
        ...
        yield* awaitUntil(() => harness.continuationRequests.length === 1, "voice resubmit");
