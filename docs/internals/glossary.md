...
| Checkout scope | A project checkout shared by sibling threads, including their terminals, previews, open files, and Git diff state. See [Threads in the same checkout](../user/worktree-scoped-threads.md). |
